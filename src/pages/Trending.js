...
const Trending = () => {
  ...
  const alias = 'products?&filter[status][value]=1&sort[sort-radioactivity][path]=field_radioactivity.energy&sort[sort-radioactivity][direction]=DESC&page[limit]=3&include=default_variation,default_variation.field_product_images';
    ...
    <>
      <JsonLd
        item={{
          ...
          name: 'Trending',
          description: 'Currently trending on styleupeasy',
