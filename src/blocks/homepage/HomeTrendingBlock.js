...
const HomeTrendingBlock = () => {
    const [variations, setVariations] = useState();

    const aliasSuffix = 'products?&filter[status][value]=1&sort[sort-radioactivity][path]=field_radioactivity.energy&sort[sort-radioactivity][direction]=DESC&page[limit]=6&include=variations,variations.field_product_images';
    useEffect(() => {
        let isMounted = true;
                            ...
                            return (
                                <div key={variation.id}>
                                    <div className='uk-card uk-card-primary-light uk-padding-small uk-padding-remove-vertical uk-flex uk-flex-center'>
                                        ...
                                        <div className='uk-position-bottom uk-text-center uk-overlay-default'>
...
export default HomeTrendingBlock
